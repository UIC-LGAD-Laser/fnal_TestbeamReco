from ROOT import TFile,TTree,TCanvas,TH1D,TH1F,TH2F,TLatex,TMath,TEfficiency,TGraphAsymmErrors,TF1,TLegend,gROOT,gStyle, gPad, kWhite, kBlack
import ROOT
import os
...
list_htitles = [
    ...
    ["baselineRMS_vs_xy", "baselineRMSLeading", "Noise [mV]"]
]
...
if debugMode:
    outdir_q = myStyle.CreateFolder(outdir, "NoiseLeading_vs_X_fits0/")
